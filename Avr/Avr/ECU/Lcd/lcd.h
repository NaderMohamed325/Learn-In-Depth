 ...
 */
typedef struct {
    Pin_config_t lcd_rs; /**< GPIO configuration for LCD RS pin. */
    Pin_config_t lcd_en; /**< GPIO configuration for LCD EN pin. */
    Pin_config_t lcd_data[4]; /**< Array of GPIO configurations for LCD data pins (4 bits). */
} lcd_4bit_mode;
...
typedef struct {
    Pin_config_t lcd_rs; /**< GPIO configuration for LCD RS pin. */
    Pin_config_t lcd_en; /**< GPIO configuration for LCD EN pin. */
    Pin_config_t lcd_data[8]; /**< Array of GPIO configurations for LCD data pins (8 bits). */
} lcd_8bit_mode;
